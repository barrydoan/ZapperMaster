...
//                if (deviceVID != 0x1d6b && (devicePID != 0x0001 && devicePID != 0x0002 && devicePID != 0x0003) && deviceVID != 0x5c6 && devicePID != 0x904c) {
    ...
    companion object {
        ...
        const val ACTION_USB_READY = "com.temple.zappermaster.USB_READY"
        ...
        const val ACTION_USB_NOT_SUPPORTED = "com.temple.zappermaster.USB_NOT_SUPPORTED"
        const val ACTION_NO_USB = "com.temple.zappermaster.NO_USB"
        const val ACTION_USB_PERMISSION_GRANTED = "com.temple.zappermaster.USB_PERMISSION_GRANTED"
        const val ACTION_USB_PERMISSION_NOT_GRANTED =
            "com.temple.zappermaster.USB_PERMISSION_NOT_GRANTED"
        const val ACTION_USB_DISCONNECTED = "com.temple.zappermaster.USB_DISCONNECTED"
        const val ACTION_CDC_DRIVER_NOT_WORKING =
            "com.temple.zappermaster.ACTION_CDC_DRIVER_NOT_WORKING"
        const val ACTION_USB_DEVICE_NOT_WORKING =
            "com.temple.zappermaster.ACTION_USB_DEVICE_NOT_WORKING"
        const val MESSAGE_FROM_SERIAL_PORT = 0
        const val CTS_CHANGE = 1
        const val DSR_CHANGE = 2
        private const val ACTION_USB_PERMISSION = "com.temple.zappermaster.USB_PERMISSION"
